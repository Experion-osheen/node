...
httpObj.onreadystatechange=function()
{
    ...
    if(this.readyState=='4' && this.status=='200')
    {
        ...
        result=JSON.parse(result);
            ...
            content = "<div class='table-responsive'><table class='table table-hover' id='table1'><thead><tr><th>Cause</th><th>Source</th><th>Destination</th><th>Mode</th><th>FromDate</th><th>Todate</th><th>No:days</th><th>Priority</th><th>Status</th><th>ProjectId</th></tr></thead><tbody>";
        var i = 1;
